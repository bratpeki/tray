...
public class PrintOptions {
    ...
    public PrintOptions(JSONObject configOpts, PrintOutput output, PrintingUtilities.Format format) {
        if (JSONObject.NULL.equals(configOpts)) { return; }
        ...
        if (!configOpts.isNull("encoding")) {
            ...
            if (!JSONObject.NULL.equals(encodings)) {
        ...
        if (!configOpts.isNull("spool")) {
            ...
            if (!JSONObject.NULL.equals(spool)) {
        ...
        if (!configOpts.isNull("density")) {
            ...
            if (!JSONObject.NULL.equals(asymmDPI)) {
        ...
        if (!configOpts.isNull("margins")) {
            ...
            if (!JSONObject.NULL.equals(subMargins)) {
                //each individually
        ...
        if (!configOpts.isNull("size")) {
            ...
            if (!JSONObject.NULL.equals(subSize)) {
